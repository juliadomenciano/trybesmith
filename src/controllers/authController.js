...
var AuthController = /** @class */ (function () {
    function AuthController(service) {
        if (service === void 0) { service = new authService_1.default(); }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.service.validateBody(req.body)];
                    case 1:
                        _b.sent();
                        return [4 /*yield*/, this.service.login(username, password)];
                    case 2:
                        token = _b.sent();
